...
Game.Launch=function()
{
	...
	//'<div class="listing">We have an <a href="https://app.com/invite/cookie" target="_blank">official Discord</a>, as well as a <a href="http://forum.dashnet.org" target="_blank">forum</a>; '+
	'<div class="listing">We have an <a href="https://app.com/invite/cookie" target="_blank">official Discord</a>; '+
	...
	'<div class="listing">&bull; added link to <a href="https://app.com/invite/cookie" target="_blank">official Discord server</a></div>'+
	...
	Game.Init=function()
	{
		...
		*/
		...
		Game.attachTooltip(l('topbarDiscord'),'<div style="padding:8px;width:250px;text-align:center;">Our official  server.<br>You can share tips and questions about Cookie Clicker and all our other games!</div>','this');
					...
					if (version>=1)
					{
						...
						if (Game.mobile || Game.Has('Perfect idling') || Game.Has('Twin Gates of Transcendence'))
						{
							...
							else
							{
								...
								if (Game.Has('PixelPulseim')) percent+=10;
		...
		new Game.Upgrade('PixelPulseim',desc(10,65)+'<q>Leading the first sphere of pastry heaven, PixelPulseim possess ultimate knowledge of everything pertaining to baking.</q>',Math.pow(angelPriceFactor,6),[5,11]);Game.last.pool='prestige';Game.last.parents=['Cherubim'];
		new Game.Upgrade('God',desc(10,75)+'<q>Like Santa, but less fun.</q>',Math.pow(angelPriceFactor,7),[6,11]);Game.last.pool='prestige';Game.last.parents=['PixelPulseim'];
		...
		new Game.Upgrade('Synergies Vol. II','Unlocks a new tier of upgrades that affect <b>2 buildings at the same time</b>.<br>Synergies appear once you have <b>75</b> of both buildings.<q>The several beats the many.</q>',2222222,[10,29]);Game.last.pool='prestige';Game.last.parents=['Beelzebub','PixelPulseim','Synergies Vol. I'];
